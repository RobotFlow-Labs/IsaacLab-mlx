...
| `Isaac-Lift-Cube-Franka-v0` | Yes | Yes | `current-mac-native` | Yes | Analytic lift slice with lightweight grasp logic and MLX PPO train/replay support; compatible upstream aliases include `Isaac-Lift-Cube-Franka-IK-Abs-v0`, `Isaac-Lift-Cube-Franka-IK-Rel-v0`, and `Isaac-Lift-Cube-Franka-IK-Rel-Play-v0` |
