...
"""Installed CLI surface for runtime diagnostics."""
...
from .runtime import build_runtime_diagnostics_payload, resolve_runtime_selection


def runtime_diagnostics_main() -> int:
...
if __name__ == "__main__":
    raise SystemExit(runtime_diagnostics_main())
