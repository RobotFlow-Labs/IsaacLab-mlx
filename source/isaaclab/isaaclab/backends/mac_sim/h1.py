...
"""Mac-native H1 locomotion tasks and MLX training helpers."""
...
class MacH1FlatSimBackend(MacSimBackend):
    """A humanoid locomotion simulator for MLX/mac-sim."""
...
class MacH1FlatEnv:
    """A vectorized H1 locomotion environment on MLX/mac-sim."""
...
class MacH1RoughEnv(MacH1FlatEnv):
    """A vectorized rough-terrain H1 locomotion environment on MLX/mac-sim."""

    def __init__(self, cfg: MacH1RoughEnvCfg | None = None):
