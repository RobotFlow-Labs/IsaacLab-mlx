...
def test_create_sensor_backend_follows_runtime():
    ...
    assert mac_state["sensor_surface"] == {
    ...
    assert mac_state["sensor_surface_sources"] == {
    ...
    assert mac_state["sensor_boundaries"] == {
        "proprioception": {
            "shared": True,
            "task_local": False,
