...
def test_mlx_cli_module_normalizes_reduced_openarm_and_ur10_aliases(tmp_path: Path):
    eval_cases = [
        ...
        ("Isaac-Lift-Cube-Franka-IK-Rel-Play-v0", "franka-lift"),
        ("Isaac-Stack-Cube-Instance-Randomize-Franka-Play-v0", "franka-stack-instance-randomize"),
        ("Isaac-Stack-Cube-Franka-IK-Abs-Play-v0", "franka-stack"),
        ("Isaac-Stack-Cube-RedGreen-Franka-IK-Rel-Play-v0", "franka-stack"),
        ("Isaac-Stack-Cube-BlueGreen-Franka-IK-Rel-Play-v0", "franka-stack"),
        ("Isaac-Stack-Cube-BlueGreenRed-Franka-IK-Rel-Play-v0", "franka-stack-rgb"),
    ]
    train_cases = [
        ...
        ("Isaac-Stack-Cube-Instance-Randomize-Franka-IK-Abs-v0", "franka-stack-instance-randomize"),
